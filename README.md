...
Веб-приложение для управления задачами с поддержкой создания, редактирования и удаления. Реализовано на React с использованием архитектуры Feature-Sliced Design.
